<?php
class Tovary_kategoriiEditBO{
	var $id;
	var $dbproduct;
	var $product;
var $dbcategory;
var $listcategory;
function Tovary_kategoriiEditBO(){
...
//получаем лист для lookUp
	...
	function Paint(){
		?>
		<a href='?view=Tovary_kategoriiViewBO'>К списку</a>
		<table border="1">
		<form method="POST" enctype="multipart/form-data" action="?view=Tovary_kategoriiEditBO&action=updateTovary_kategoriiActionBO&id=<?=$this->id?>">
