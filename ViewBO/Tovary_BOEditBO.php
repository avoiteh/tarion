<?php
class Tovary_BOEditBO{
	var $id;
	var $dbproduct;
	var $product;
var $dbcategory;
var $listcategory;
function Tovary_BOEditBO(){
...
//получаем лист для lookUp
	...
	function Paint(){
		?>
		<a href='?view=Tovary_BOViewBO'>К списку</a>
		<table border="1">
		<form method="POST" enctype="multipart/form-data" action="?view=Tovary_BOEditBO&action=updateTovary_BOActionBO&id=<?=$this->id?>">
