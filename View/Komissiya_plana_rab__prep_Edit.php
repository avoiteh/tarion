<?php
class Komissiya_plana_rab__prep_Edit{
	var $id;
	var $dbprepod_plan;
	var $prepod_plan;
var $dbfront_user;
...
var $dbkomiss;
var $listkomiss;
function Komissiya_plana_rab__prep_Edit(){
...
//получаем лист дл€ lookUp
	...
	function Paint(){
		?>
		<a href='?view=Komissiya_plana_rab__prep_View'>  списку</a>
		<table border="1">
		<form method="POST" enctype="multipart/form-data" action="?view=Komissiya_plana_rab__prep_Edit&action=updateKomissiya_plana_rab__prep_Action&id=<?=$this->id?>">
