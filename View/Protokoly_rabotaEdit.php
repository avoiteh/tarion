<?php
class Protokoly_rabotaEdit{
	var $id;
	var $dbprotokols;
	var $protokols;
var $dbkomiss;
var $listkomiss;
function Protokoly_rabotaEdit(){
...
//получаем лист для lookUp
	...
	function Paint(){
		?>
		<a href='?view=Protokoly_rabotaView'>К списку</a>
		<table border="1">
		<form method="POST" enctype="multipart/form-data" action="?view=Protokoly_rabotaEdit&action=updateProtokoly_rabotaAction&id=<?=$this->id?>">
